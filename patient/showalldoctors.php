...
<head>
  ...
  <!-- Bootstrap CSS -->
  <link href="doctor/card.css" rel="stylesheet">
...
<div class="navbar">
    ...
    <ul class="navbar-links">
      <li><a href="patient/homepagepatient.php"><i class="fa fa-angle-left"></i> Back</a></li>
              ...
              <div class="col-md-3 mt-3">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <?php
                    echo '
        <a class="cbtnn1" href="requests/sendbookreq.php?docid=' . $sno . '">Send Request</a>   
        <a class="cbtnn3" href="reviews/writereview.php?docid=' . $sno . '">Review Here</a>                   
        <a class="cbtnn2" href="reviews/showreview.php?docid=' . $sno . '">Reviews</a>           
