...
<div class="sidenav">
  <a href="patient/patientprofile.php"><i class="fas fa-user"></i> My Profile</a>
  <a href="patient/myappointments.php"><i class="fa fa-stethoscope"></i> My Appoinments</a>
  <a href="patient/patientviewreq.php"><i class="fa fa-medkit"></i> My Requests</a>
  <a href="patient/patientlogout.php"><i class="fa fa-fw fa-sign-out"></i> Log Out</a>
</div>
    ...
    <script type="text/javascript">
      ...
      $("#search_result").html("");
        ...
        <button class="btnn show" onclick="window.location.href='patient/showalldoctors.php';"> Show All</button>
        <button class="btnn" onclick="window.location.href='patient/checklocation.php';"> Location</button>
        <button class="btnn" onclick="window.location.href='patient/checkcategory.php';"> Category</button>
