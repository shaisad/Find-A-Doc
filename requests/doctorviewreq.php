...
Booking Requests
  ...
  <link rel="stylesheet">
  <link rel="stylesheet" href="requests/doctorviewreq.css">
...
<body>
  <div class="navbar">
    ...
    <ul class="navbar-links">
      ...
      <li><a href="doctor/doctorprofile.php"><i class="fa fa-angle-left"></i> Back</a>
      ...
      <tbody>
        ...
        while ($row = mysqli_fetch_array($result)) {
          ...
          <tr>
            ...
            <td>
              <form action="requests/processrequest.php?requestId=<?php echo $requestId; ?>" method="post" class="action-buttons">
